      ...
      <div style={shellStyle}>
        ...
        <ToolbarScrollArea io={io} mobileChrome={mobileChrome}>
          ...
          {onSkeletonShowFootLineChange !== undefined &&
            chk('sf', 'Foot line', skeletonShowFootLine ?? false, onSkeletonShowFootLineChange, <Minus size={18} strokeWidth={2} />)}
  ...
  if (top === 'stromotion') {
    return (
      <div style={shellStyle}>
        ...
        <ToolbarScrollArea io={io} mobileChrome={mobileChrome}>
          <ToolbarLead chrome={chrome} />
          <BackHeader chrome={chrome} title="Motion Layer" icon={<Layers size={18} />} />
          {stroMotionPanel ?? (
            <>
              {onStroMotionToggle ? (
                <Row chrome={chrome}
